...
public class ControladorProducto1Test {
    ...
    public void RegistrarProductoTest() throws Exception {
        try {
            ...
            DataEspecificacionProducto espProducto = new DataEspecificacionProducto("esp10", "nombre_prod", "nuevo", new HashMap<>(), (float) 2500.0, proveedor1, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList());
