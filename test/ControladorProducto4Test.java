...
public class ControladorProducto4Test {
    ...
    public void VerInformaciondeProductoTest() throws Exception {
        try {
            ...
            DataEspecificacionProducto espProducto2 = new DataEspecificacionProducto("nroref201", "nombre_prod2", "usado", new HashMap<>(), (float) 12.0, proveedor2, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList());
