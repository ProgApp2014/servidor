...
public class TestControladorProducto {
    ...
    public void AltaDeCategoriaTest() {
        ...
        controlarProducto.eliminarCategoria("cat3");
        controlarProducto.eliminarCategoria("cat2");
...
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("nroref1").getListaProductos().get(0).getEspecificacionProducto().getNombre(), "prod1");
...
//        controlarUsuario.guardarUsuario();
//
//        DataCategoria cat1 = new DataCategoria("categ", null);
...
//        controlarProducto.agregarCategoriaAEspecificacion("categ");
//        controlarProducto.agregarImagen("img");
//        controlarProducto.guardarProducto();
//
//        assertTrue(!isNull(controlarProducto.controlarErrores()));
//        assertTrue(!isNull(ManejadorProductos.getInstance().obtenerProductos()));
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod1").getListaProductos().get(0).getIdEspecifico(), "idesp1");
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod1").getListaProductos().get(0).getEspecificacionProducto().getDescripcion(), "descripcion 1");
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod1").getListaProductos().get(0).getEspecificacionProducto().getNombre(), "Producto1");
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod1").getListaProductos().get(0).getEspecificacionProducto().getNroReferencia(), "prod1");
//        assertTrue((ManejadorEspProductos.getInstance().getEspecificacionProducto("prod1").getListaProductos().get(0).getEspecificacionProducto().getPrecio() == (float) 12.0));
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod1").getListaProductos().get(0).getEspecificacionProducto().getDataProveedor().getLinkSitio(), "www.alpiste.com");
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod1").getListaProductos().get(0).getEspecificacionProducto().getDataProveedor().getNombreCompania(), "Alpiste");
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod1").getListaProductos().get(0).getEspecificacionProducto().getDataProveedor().getNombre(), "Gallo");
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod1").getListaProductos().get(0).getEspecificacionProducto().getDataProveedor().getApellido(), "Claudio");
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod1").getListaProductos().get(0).getEspecificacionProducto().getDataProveedor().getNickname(), "gclaud");
//        Calendar cal1 = Calendar.getInstance();
//        cal1.set(1960, 11, 1);
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod1").getListaProductos().get(11).getEspecificacionProducto().getDataProveedor().getFechaNacimiento().compareTo(cal1), 0);
//
...
//        Calendar cal = Calendar.getInstance();
//        cal.set(1960, 11, 1);
//        controlarUsuario.ingresarDatosProveedor(new DataProveedor("bbunny", "Gallo", "Claudio", "gclaudio@mail.com", cal, "Alpiste", "www.alpiste.com"));
//        controlarUsuario.guardarUsuario();
//
...
//        DataEspecificacionProducto espProducto = new DataEspecificacionProducto("prod2", "Producto1", "descripcion 1", new HashMap(), (float) 12.0, proveedor, new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
//        controlarProducto.ingresarDatosProductos(espProducto);
//        controlarProducto.ingresarEspecificacion("estado", "nuevo");
//        controlarProducto.ingresarEspecificacion("color", "gris");
...
//
//        //Modificar Producto
//        DataEspecificacionProducto espProducto2 = new DataEspecificacionProducto("prod2", "Cambio", "nuevo", new HashMap(), (float) 2500.0, proveedor, new ArrayList<String>(), new ArrayList<DataCategoria>(), new ArrayList<>());
//
...
//        }
//
//        assertTrue(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod2").getListaProductos().get(5).getEspecificacionProducto().getPrecio() == (float) 2500);
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod2").getListaProductos().get(5).getEspecificacionProducto().getDescripcion(), "nuevo");
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod2").getListaProductos().get(5).getEspecificacionProducto().getNombre(), "Cambio");
//        assertEquals(ManejadorEspProductos.getInstance().getEspecificacionProducto("prod2").getListaProductos().get(5).getEspecificacionProducto().getNroReferencia(), "prod2");
//
